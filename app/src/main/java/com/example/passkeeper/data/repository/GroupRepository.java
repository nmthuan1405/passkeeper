...
public class GroupRepository {
    ...
    public LiveData<Resource<List<Record>>> fetchListRecordGroup(Integer groupId) {
        MutableLiveData<Resource<List<Record>>> listRecord = new MutableLiveData<>(Resource.NONE());
