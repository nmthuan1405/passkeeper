...
public class AddGroupMemberDialog extends AppCompatDialogFragment {
    private EditText edtMemberEmail;
    private AddGroupMemberDialogListener listener;
    @NonNull
    @Override
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.add_group_member_dialog, null);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (AddGroupMemberDialogListener) context;
